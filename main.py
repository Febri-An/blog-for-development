...
def show_post(post_id):
    ...
    if cform.validate_on_submit():
        ...
        new_comment = Comment(text=cform.comment.data,
                              author=current_user,
                              parent_post=requested_post)
        db.session.add(new_comment)
        db.session.commit()
    return render_template("post.html", post=requested_post, cform=cform, logged_in=current_user.is_authenticated, gravatar=gravatar)
